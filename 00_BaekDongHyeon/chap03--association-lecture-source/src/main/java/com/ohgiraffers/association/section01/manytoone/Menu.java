...
public class Menu {
  ...
  //  @GeneratedValue(strategy = GenerationType.IDENTITY)
     ...
     * - cascade = CascadeType.PERSIST : 부모가 저장될 때 자식도 같이 저장 -> 부장자장
     *      자식이 저장(persist)될 때 부모도 같이 저장(persist)
     *
     ...
     * - 조인을 위한 외래키(FK) 컬럼 매핑
     * */
    @ManyToOne(cascade = CascadeType.PERSIST, fetch = FetchType./*EAGER*/LAZY)
